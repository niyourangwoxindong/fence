...
//    _threeArr = [[NSMutableArray alloc]initWithObjects:@"推荐分期计算器给好友",@"给分期计算器评分",@"当前版本号", nil];
    _threeArr = [[NSMutableArray alloc]initWithObjects:@"推荐分期计算器给好友",@"当前版本号", nil];
...
//    }
    if (indexPath.row == 0)
    {
        ...
        [manager shareInView:self.view text:@"不做“负翁“”做“富翁”！！！！！" image:[UIImage imageNamed:@"home_icon_fenqi"] url:@"https://www.youjin360.com/mobile/page/loanStages.html" title:@"快来下载分期计算器" objid:nil];
    }
}
