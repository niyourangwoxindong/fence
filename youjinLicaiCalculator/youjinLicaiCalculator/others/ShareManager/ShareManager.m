...
- (void)configureWithPlatformType:(SSDKPlatformType)type appInfo:(NSMutableDictionary *)appInfo {
    switch (type) {
        case SSDKPlatformTypeSinaWeibo:
            [appInfo SSDKSetupSinaWeiboByAppKey:@"3661692823"
                                      appSecret:@"0b34ccd2d2e614300c590a1843541f18"
                                    redirectUri:@"http://www.sharesdk.cn"
                                       authType:SSDKAuthTypeBoth];
            break;
        case SSDKPlatformTypeWechat:
            [appInfo SSDKSetupWeChatByAppId:@"wxf36d6effdaf21a37"
                                  appSecret:@"fae57b0ca087a9312a2968d4574ed55f"];
            break;
        case SSDKPlatformTypeQQ:
            [appInfo SSDKSetupQQByAppId:@"1106248718"
                                 appKey:@"OVrLt7rAvfJfU4tS"
